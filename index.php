...
Авторизован!
<br>
Привет, <?php echo $_SESSION['loged_user']->login;?>
<hr>
...
else if ($Page == 'signup') include('signup.php');
else if ($Page == 'account') include('form/account.php');
else if ($Page == 'reg') include('reg.php');
else if ($Page == 'admin') include('tamplates/admin/loginForm.php');
...
function Menu (){
	echo '<div id="templatemo_wrapper_outer">
